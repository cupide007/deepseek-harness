 ...
 * Web shape only — a browser or desktop shell loads the served origin and
 * carries fetch over its selected client transport. This package never prints:
 * the URL line belongs to the shell.
 */
